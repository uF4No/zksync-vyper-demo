...
export const deployAndVerifyContract = async (contractArtifactName: string, constructorArguments?: any[], options?: DeployContractOptions) => {
  ...
  if (process.env.NODE_ENV != 'test' && process.env.NODE_ENV != 'TEST'){
    ...
    console.log(`${fullContractSource} verified! VerificationId: ${verificationId}`);
  }
  console.log(`Done!`);
